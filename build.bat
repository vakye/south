...
set CompileFlags=-std=c11 -Wall -Wextra -Wpedantic -g -O0 -target x86_64-unknown-windows -ffreestanding -mno-red-zone -mno-stack-arg-probe -nostdlib -fuse-ld=lld -nostdlib
